...
function FormShelf() {
    ...
    async function handleSubmit(event: any) {
        ...
        fetch(`http://localhost:8081/shelf?query=mutation+_{create(name:"${submitValues.name}",room:"${submitValues.room}",location:"${submitValues.location}"){id,name,room,location}}`)
            .then((response) => {
